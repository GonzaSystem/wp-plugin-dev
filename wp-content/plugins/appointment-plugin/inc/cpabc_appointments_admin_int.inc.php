 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
    ...
    <table class="form-table">
        ...
        <td><input type="checkbox" readonly disabled name="enable_paypal" size="40" value="0"/> <em>The feature for working without PayPal is implemented/available in the <a href="https://abc.dwbooster.com/download">commercial versions</a>.</em>
        </td>
        </tr>                   
